#ifndef STONEFISHVISUALIZER_H
#define STONEFISHVISUALIZER_H
...
class StoneFishROVVisualizer : public rclcpp::Node {
    ...
    rclcpp::Publisher<nav_msgs::msg::Odometry>::SharedPtr rovPosePub_;

    visualization_msgs::msg::Marker rovMarker_;
    nav_msgs::msg::Odometry rovPose_;
    ...
    rml::EulerRPY bodyF_ROV_;


public:
    StoneFishROVVisualizer(const std::string file_name);
